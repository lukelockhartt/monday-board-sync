...
1. **Source Item ID Column**: Each destination board item stores the source board's item ID in the column configured via `SOURCE_ITEM_ID_COLUMN`
...
self.column_id_mapping = {
    os.getenv("SRC_COMPLETION_COL"): os.getenv("DEST_COMPLETION_COL"),  # completion_status
    os.getenv("SRC_VENDOR_COL"): os.getenv("DEST_VENDOR_COL"),          # vendor
    os.getenv("SRC_DATE_SOLD_COL"): os.getenv("DEST_DATE_SOLD_COL"),    # date_sold
    os.getenv("SRC_FILE_COL"): os.getenv("DEST_FILE_COL"),              # file_column
}
```
...
**GitHub**: [monday-board-sync](https://github.com/YOUR_GITHUB_USERNAME/monday-board-sync)
